...
export const OPERATIONS: Record<string, string> = {
  ...
  ScopeSupervisionController_get: 'mgmt.scopes.supervision(id).get()',
  ScopeSupervisionController_set: 'mgmt.scopes.supervision(id).set()',
  ScopeSupervisionController_setActive: 'mgmt.scopes.supervision(id).setActive()',
  ...
  WorkflowsController_toggle: 'mgmt.workflows.toggle()',
  ...
  WorkflowInterfacesController_list: 'mgmt.workflows.interfaces(id).list()',
  WorkflowInterfacesController_add: 'mgmt.workflows.interfaces(id).create()',
  WorkflowInterfacesController_update: 'mgmt.workflows.interfaces(id).update()',
  WorkflowInterfacesController_delete: 'mgmt.workflows.interfaces(id).delete()',
  WorkflowInterfacesController_deleteAll: 'mgmt.workflows.interfaces(id).deleteAll()',
